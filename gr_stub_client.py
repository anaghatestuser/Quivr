...
def call_gr_enforce(
    ...
    try:
        ...
        if result.get("status") == "escalate":
            # LINEAJE: enforce() `hop` at agent->log log_emit — scan flagged AI_DAT_SEC_029 (Enforce decision logging, audit trail, and forensic readiness for AI-driven actions.). Mask/block; do not remove without review. site_id='site:sha256:c8c1d4522441153b99d642ccbfe4995fe165002cc598d21076a6ad3b9dc68f22'
        ...
        if exc.code == 403:
            ...
            # LINEAJE: enforce() `hop` at agent->log log_emit — scan flagged AI_DAT_SEC_030 (Enforce minimum six-month log retention for high-risk AI systems). Mask/block; do not remove without review. site_id='site:sha256:51615e48aeaa6fdf67995ba9f16b8b3569722af3bd0cf3151f2398a9dc08e2ed'
            _gr_client = _lineaje_load_gr_client()
