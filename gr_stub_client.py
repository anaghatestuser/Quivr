...
def check(
    ...
    *,
    ...
    try:
        ...
        # LINEAJE: enforce() `exc` at agent->log log_emit — scan flagged AI_DAT_SEC_029 (Enforce decision logging, audit trail, and forensic readiness for AI-driven actions.). Mask/block; do not remove without review. site_id='site:sha256:ffe543a0e35b76f2fff4d99639fbc0dd1b3586b8b0df7d50ce8affb9359c9c00'
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:ffe543a0e35b76f2fff4d99639fbc0dd1b3586b8b0df7d50ce8affb9359c9c00', phase='log_emit', boundary={'source': 'log', 'sink': 'log'}, candidate_policies=[{'policy_id': 'AI_DAT_SEC_010', 'guardrail_id': 'Mask PII in Logs', 'policy_version': '2026.08.1'}], fail_mode='BLOCK', source_type='agent', destination_type='log')
    ...
    try:
            ...
            if _should_register_unknown_site(detail, str(body.get("site_id") or "")):
                ...
                if mappings is not None:
                    ...
                    try:
                        ...
                        # LINEAJE: enforce() `decision` at agent->user_interface data_egress — scan flagged AI_DAT_SEC_029 (Enforce decision logging, audit trail, and forensic readiness for AI-driven actions.). Mask/block; do not remove without review. site_id='site:sha256:207cc7ffaa5d3fdcd8f3756a175fa4d05d51c6ae7445f324080ec0f185566218'
                        _gr_client = _lineaje_load_gr_client()
                        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:207cc7ffaa5d3fdcd8f3756a175fa4d05d51c6ae7445f324080ec0f185566218', phase='data_egress', boundary={'source': 'agent_message', 'sink': 'user_interface'}, candidate_policies=[{'policy_id': 'AI_DAT_SEC_012', 'guardrail_id': 'Mask PII on UI', 'policy_version': '2026.08.1'}], fail_mode='BLOCK', source_type='agent', destination_type='user_interface')
                ...
                try:
                    ...
                    # LINEAJE: enforce() `hop` at agent->log log_emit — scan flagged AI_DAT_SEC_029 (Enforce decision logging, audit trail, and forensic readiness for AI-driven actions.). Mask/block; do not remove without review. site_id='site:sha256:51615e48aeaa6fdf67995ba9f16b8b3569722af3bd0cf3151f2398a9dc08e2ed'
                    _gr_client = _lineaje_load_gr_client()
                    _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:51615e48aeaa6fdf67995ba9f16b8b3569722af3bd0cf3151f2398a9dc08e2ed', phase='log_emit', boundary={'source': 'log', 'sink': 'log'}, candidate_policies=[{'policy_id': 'AI_DAT_SEC_010', 'guardrail_id': 'Mask PII in Logs', 'policy_version': '2026.08.1'}], fail_mode='BLOCK', source_type='agent', destination_type='log')
        ...
        # LINEAJE: enforce() `hop` at agent->log log_emit — scan flagged AI_DAT_SEC_029 (Enforce decision logging, audit trail, and forensic readiness for AI-driven actions.). Mask/block; do not remove without review. site_id='site:sha256:096d38037dacfb611ccf14189f8752d1a54c80862df835b595a856a1fb12836c'
        _gr_client = _lineaje_load_gr_client()
...
def enforce(
    ...
    *,
    ...
    try:
        ...
        # LINEAJE: enforce() `exc` at agent->log log_emit — scan flagged AI_DAT_SEC_029 (Enforce decision logging, audit trail, and forensic readiness for AI-driven actions.). Mask/block; do not remove without review. site_id='site:sha256:0f2222fbcb7f284762e31f097f3cce22bcca52b3d2a16f5729f7cc0e5b894492'
        _gr_client = _lineaje_load_gr_client()
