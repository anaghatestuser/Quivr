...
class QuivrQARAG:
    ...
    def answer(
        ...
        # LINEAJE: enforce() `_lineaje_payload` at agent->llm pre_model — scan flagged AI_DAT_SEC_029 (Enforce decision logging, audit trail, and forensic readiness for AI-driven actions.). Mask/block; do not remove without review. site_id='site:sha256:366f751a2af57674b5f14f22d9a29536a00e71e9ba8e0f16c617ead352d160a2'
    ...
    async def answer_astream(
            ...
            if "answer" in chunk:
                ...
                if len(answer_str) > 0:
                    if self.llm_endpoint.supports_func_calling():
                        ...
                        _lineaje_payload_279 = f"answer_astream func_calling=False question={question} rolling_msg={rolling_message} chunk_id={chunk_id}, chunk={parsed_chunk}"
                        # LINEAJE: enforce() `_lineaje_payload_279` at agent->log log_emit — scan flagged AI_DAT_SEC_029 (Enforce decision logging, audit trail, and forensic readiness for AI-driven actions.). Mask/block; do not remove without review. site_id='site:sha256:1540847836c31f8db1a7f5c3e68c0ae12688d1a1fa6aaa4165ac806325d03b13'
                        _gr_client = _lineaje_load_gr_client()
                        ...
                        _lineaje_payload_279 = await __import__('asyncio').to_thread(lambda: _gr_client.enforce(_gr_site, _lineaje_payload_279, content_type='application/json'))
                        logger.debug(
                            _lineaje_payload_279
                        )
                        yield parsed_chunk
        ...
        # LINEAJE: enforce() `_lineaje_payload` at agent->log log_emit — scan flagged AI_DAT_SEC_029 (Enforce decision logging, audit trail, and forensic readiness for AI-driven actions.). Mask/block; do not remove without review. site_id='site:sha256:fd2ab0c21d00242ea31c54fa1b36114c211240eec1c6aa2f84b96cb49f17b50f'
        _gr_client = _lineaje_load_gr_client()
        ...
        # LINEAJE: enforce() `_lineaje_payload` at agent->log log_emit — scan flagged AI_DAT_SEC_029 (Enforce decision logging, audit trail, and forensic readiness for AI-driven actions.). Mask/block; do not remove without review. site_id='site:sha256:2de7567cdeb44492999a5e37bf1dc757e73cd941ddea72196f01288fb45718bb'
        _gr_client = _lineaje_load_gr_client()
