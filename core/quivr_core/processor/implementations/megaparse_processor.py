...
def _lineaje_load_gr_client():
    ...
    try:
        _mod = gr_check(_mod, "agent", "user_interface", site_id='site:sha256:11c6cb61b06b13b3a7f98df8b2873ddca6cc6d4cef6de6480adad03e105da714')
...
class MegaparseProcessor(ProcessorBase[MPDocument]):
    ...
    async def process_file_inner(
        ...
        # LINEAJE: enforce() `_lineaje_payload` at agent->log log_emit — scan flagged AI_VULN_SEC_007 (AI systems must implement incident detection, structured logging, and reporting mechanisms). Mask/block; do not remove without review. site_id='site:sha256:2866654916370240f89772d3332c5a3dd011848da7885cdd92d0d6de0a79a480'
