    ...
    async def _send_parse_tika(self, f: AsyncIterable[bytes]) -> str:
        ...
        while retry < self.max_retries:
            try:
                ...
                # LINEAJE: enforce() `_lineaje_payload` at agent->log log_emit — scan flagged AI_DAT_SEC_029 (Enforce decision logging, audit trail, and forensic readiness for AI-driven actions.). Mask/block; do not remove without review. site_id='site:sha256:e3278ed8e92ec19109ebb88abd25cf53e9a09b1aa296607cf60a51ff95bec7c4'
                _gr_client = _lineaje_load_gr_client()
